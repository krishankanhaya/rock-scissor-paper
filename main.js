...
const rockClick = () => {
    ...
    if(cResponse == 0){
        message.innerHTML = `Your's ==> <img src="./images/stone.png" alt="Rock" style="width:30px"/> "MATCH DRAW"  <img src="./images/${choice[cResponse]}.png" alt="Rock" style="width:30px"/> <== Computer's`;
    }
    else if(cResponse == 1){
...
const scissorClick = () => {
    const cResponse = getRandomInt(0,2);
    if(cResponse == 1){
        message.innerHTML = `Your's ==> <img src="./images/paper.png" alt="Rock" style="width:30px"/> "MATCH DRAW"  <img src="./images/${choice[cResponse]}.png" alt="Rock" style="width:30px"/> <== Computer's`;
    }
    else if(cResponse == 2){
...
const paperClick = () => {
    const cResponse = getRandomInt(0,2);
    if(cResponse == 2){
        message.innerHTML = `Your's ==> <img src="./images/scissors.png" alt="Rock" style="width:30px"/> "MATCH DRAW"  <img src="./images/${choice[cResponse]}.png" alt="Rock" style="width:30px"/> <== Computer's`;
    }
    else if(cResponse == 0){
